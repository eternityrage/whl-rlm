...
def main():
    ...
    title = "Majestic Humpback Whale Breach"
    description = "Witness the incredible power and beauty of a humpback whale in its natural habitat. #shorts #whales #ocean #nature"
    tags = ["whales", "humpback", "ocean", "nature"]
